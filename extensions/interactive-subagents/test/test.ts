...
describe("subagent discovery", () => {
  ...
  it("getToolExtensionPath maps custom tools and skips built-ins", () => {
    ...
    assert.ok(testApi.getToolExtensionPath("get_search_content")?.endsWith("pi-web-access/index.ts"));
    assert.ok(testApi.getToolExtensionPath("source_check")?.endsWith("pi-web-access/index.ts"));
